...
public class AlertMessage {
    ...
    public static void errorPart(int code, TextField field) {
        ...
        switch (code) {
            ...
            case 2: {
                alert.setContentText("Please select IN HOUSE / OUTSCOURCED");
                break;
            }
            case 3: {
            ...
            case 6: {
                alert.setContentText("Inventory count cannot be lower than min!");
                break;
            }
            case 7: {
                alert.setContentText("Inventory count cannot be greater than max");
                break;
            }
            case 8: {
            ...
            case 9: {
                alert.setContentText("Machine ID can only be a number");
                break;
            }
            default: {
